...
error_log  ${ settings }/log/error.log warn;
pid        ${ settings }/nginx.pid;
...
http {
    ...
    access_log  						${ settings }/log/access.log  main;
    ...
    include  	${ settings }/upstream/*.conf;
	include  	${ settings }/virtual-host/*.conf;
