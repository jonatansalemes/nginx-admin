...
<html:view>
	...
	<html:block>
		...
		<html:grid data="${ sslCertificateList }" var="sslCertificate">
			<html:gridColumn label="{ssl.common.name}">
			...
			<html:gridColumn>
				<html:buttonGroup spaced="true">
					...
					<html:button state="danger" id="${ sslCertificate.id }" icon="trash" url="#"></html:button>
