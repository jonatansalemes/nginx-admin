...
http {
	...
	<#if nginx.gzip == 1>
	    gzip 		on;
	    gzip_types 	application/json application/x-javascript application/javascript text/html text/plain text/css text/xml application/xml application/xml+rss text/javascript image/svg+xml;
    </#if>
